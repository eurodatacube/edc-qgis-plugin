...
class EDC_OGC:
    ...
    def update_selected_collection(self):
        ...
        if self.dockwidget.collections.currentText() != "":
            ...
            self.dockwidget.wave_check.setCheckState(0)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget is None:
                ...
                self.dockwidget.dim_check.stateChanged.connect(self.check_dim_box)
                ...
                self.dockwidget.wave_check.stateChanged.connect(self.check_wave_box)
